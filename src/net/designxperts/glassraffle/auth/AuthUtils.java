...
public final class AuthUtils {
	...
	//END:scopes
	  ...
	  public static final String WEB_CLIENT_ID = "95950566730.apps.googleusercontent.com";
	  public static final String WEB_CLIENT_SECRET = "Eg81Zc9XwnXvmrHsLg03FXN2";

	  public static final String OAUTH2_PATH = "/oauth2callback";
	  public static final String API_KEY = "AIzaSyAaNPHWlbzPAjCgurUwuEBRZqVkJxkku2w";
